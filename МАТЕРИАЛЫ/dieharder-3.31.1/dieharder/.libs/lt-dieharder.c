...
/* ./.libs/lt-dieharder.c - temporary wrapper executable for .libs/dieharder
   Generated by libtool (GNU libtool) 2.2.10

   The dieharder program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dieharder"; /* hopefully, no .exe */
...
main (int argc, char *argv[])
{
  ...
  lt_debugprintf (__FILE__, __LINE__, "libtool wrapper (GNU libtool) 2.2.10\n");
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# dieharder - temporary wrapper script for .libs/dieharder\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.2.10\n", f);
  fputs ("#\n", f);
  fputs ("# The dieharder program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  generated_by_libtool_version='2.2.10'\n", f);
  ...
  fputs ("    echo \"dieharder:dieharder:${LINENO}: libtool wrapper (GNU libtool) 2.2.10\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dieharder:dieharder:${LINENO}: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dieharder:dieharder:${LINENO}: newargv[0]: $progdir/$program\" 1>&2\n", f);
